...
export const IconAttach = ({ size = 17 }: P) => (
  <svg {...svg(size)}>
    <path d="M18 8 L9.5 16.5 a3 3 0 0 1 -4.2 -4.2 L14 3.5 a2 2 0 0 1 2.8 2.8 L8.3 14.8 a1 1 0 0 1 -1.4 -1.4 L15 5" />
  </svg>
);

export const IconLink = ({ size = 17 }: P) => (
  <svg {...svg(size)}>
    <path d="M9.5 14.5 a3.5 3.5 0 0 1 0 -5 L12 7 a3.5 3.5 0 0 1 5 5 L15.8 13.2" />
    <path d="M14.5 9.5 a3.5 3.5 0 0 1 0 5 L12 17 a3.5 3.5 0 0 1 -5 -5 L8.2 10.8" />
  </svg>
);
